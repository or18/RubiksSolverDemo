...
OUTPUT_JS="xcross_free_pair_solver_prod.js"
OUTPUT_WASM="xcross_free_pair_solver_prod.wasm"
SRC_FILE="xcross_free_pair_solver_prod.cpp"
...
em++ -O3 -I. "${SRC_FILE}" -o "${OUTPUT_JS}" \
    ...
    -s MODULARIZE=1 \
    -s EXPORT_NAME="createXCrossFreePairModule" \
