...
importScripts('xxcross_solver_prod.js');

const modulePromise = (async () => {
    try {
        console.log('[Worker] Initializing WASM module (calling createXXCrossModule)...');
        Module = await self.createXXCrossModule();
        console.log('[Worker] Constructing xxcross_search single-instance...');
        searchInstance = new Module.xxcross_search();
        console.log('[Worker] xxcross_search ready.');
