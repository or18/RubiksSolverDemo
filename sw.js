const CACHE_NAME = 'pwa-cache_v82';
...
const urlsToCache = [
    ...
    'f2leo_xcross_trainer.html',
    'f2leo_xxcross_trainer.html',
    'documentation.html',
    'eocross_trainer.html',
    'xeocross_trainer.html',
    'xxeocross_trainer.html',
    'pairing_trainer.html',
    'xcross_pairing_trainer.html',
    'xcross_pairing_trainer_new.html',
    'pseudo_pairing_trainer.html',
    'pseudo_xcross_trainer.html',
    'xcross_trainer.html',
    'xxcross_trainer.html',
    'xxcross_trainer_new.html',
    'xxxcross_trainer.html',
    'jsonEditor.html',
    'algTrainer.html',
    'manifest.json',
    'icons/icon-512x512.png',
    ...
    'src/XEOCrossTrainer/xeocross_solver_prod.js',
    'src/XEOCrossTrainer/xeocross_solver_prod.wasm',
    'src/XEOCrossTrainer/worker.js',
    'src/XXEOCrossTrainer/xxeocross_solver_prod.js',
    'src/XXEOCrossTrainer/xxeocross_solver_prod.wasm',
    'src/XXEOCrossTrainer/worker.js',
    ...
    'src/xxcrossTrainer_new/xxcross_solver_prod.js', 
    'src/xxcrossTrainer_new/xxcross_solver_prod.wasm', 
    'src/xxcrossTrainer_new/worker.js',
    'src/xxxcrossTrainer/xxxcross_solver_prod.js',
    'src/xxxcrossTrainer/xxxcross_solver_prod.wasm',
    'src/xxxcrossTrainer/worker.js',
    'src/xcross_free_pair_trainer/production/solver_prod.js',
    'src/xcross_free_pair_trainer/production/solver_prod.wasm',
    'src/xcross_free_pair_trainer/production/worker_prod.js',
    'src/xcross_free_pair_trainer_new/xcross_free_pair_solver_prod.js',
    'src/xcross_free_pair_trainer_new/xcross_free_pair_solver_prod.wasm',
    'src/xcross_free_pair_trainer_new/worker.js',
    ...
    'src/F2LEO_xcrossTrainer/f2leo_xcross_solver.js',
    'src/F2LEO_xcrossTrainer/f2leo_xcross_solver.wasm',
    'src/F2LEO_xcrossTrainer/worker.js',
    'src/F2LEO_xxcrossTrainer/f2leo_xxcross_solver.js',
    'src/F2LEO_xxcrossTrainer/f2leo_xxcross_solver.wasm',
    'src/F2LEO_xxcrossTrainer/worker.js',
